...
# run rake db:non_rss_feeds:crawl_dow_jones_non_rss_feed_sections
namespace :db do
  namespace :non_rss_feeds do
    task(
      :crawl_dow_jones_non_rss_feed_sections,
      [
        :non_rss_feed_name,
        :rss_feed_publisher,
        :bucket_name,
      ...
      ::Rails.logger.info(
        'db:non_rss_feeds:crawl_dow_jones_non_rss_feed_sections ' \
