...
describe NonRssFeeds::DowJones::ArticlesToRssFeeder do
  let(:article) do
    {
      ...
      image_credit: 'this is a image credit',
  ...
  describe '#xml_rss_feed' do
    ...
    it 'adds the correct image credit' do
      expect(result.image_credit).to eq(articles.first[:image_credit])
    end
